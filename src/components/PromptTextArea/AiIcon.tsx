		...
		>
			<g clipPath="url(#clip0_3002_747)">
				<path
					...
					fill="url(#paint0_linear_3002_747)"
				/>
				<path
					...
					fill="url(#paint1_linear_3002_747)"
				/>
			</g>
			<defs>
				<linearGradient
					id="paint0_linear_3002_747"
					x1="11.8581"
					y1="3.36918"
					x2="7.62241"
					y2="12.3359"
				...
				<clipPath id="clip0_3002_747">
					<rect width="18" height="18" rx="4.04082" transform="matrix(-1 0 0 1 18 0)" fill="white" />
				</clipPath>
			</defs>
		</svg>
	);
